...
from configs import fsdp_config, train_config, quantization_config, lora_config, wandb_config
...
def main(train_config, 
    ...
    tokenizer = AutoTokenizer.from_pretrained(train_config.model_name if train_config.tokenizer_name is None else train_config.tokenizer_name, token=os.environ["HF_ACCESS_TOKEN"])
    ...
    if train_config.enable_fsdp and train_config.pure_bf16 and not train_config.quantization:
    ...
    if train_config.enable_fsdp:
        ...
        model = FSDP(
            ...
            mixed_precision=mixed_precision_policy if not train_config.pure_bf16 else None,
...
if __name__ == "__main__":
    parser = HfArgumentParser((train_config, fsdp_config, lora_config, quantization_config, wandb_config))
